...
import HomeFeatures from "@/components/blocks/Home/FeatureSection";
...
export default function Home() {
  return (
    <motion.div
      className="w-full h-screen grid grid-rows-[7vh_58vh_1.5vh_auto_1.5vh_auto_1.5vh_30vh_5vh] grid-cols-[5%_90%_5%] md:grid-cols-[10%_80%_10%] lg:grid-cols-[15%_70%_15%] overflow-x-hidden"
      {...pageTransition}
    >
      <Navbar />
      <HeroSection />
